...
function PenawaranProyek(props) {
  return (
    <>
      ...
      <div style={{ width: '90%', paddingBottom: '80px', marginTop: '72px' }} className="mx-auto">
        ...
        <div style={{ maxWidth: '1349px' }} className="mx-auto">
          ...
          <div style={{ marginBottom: '48px' }}>
            <h1 style={{ fontWeight: 700, fontSize: '32px' }}>⚒️ Tawaran Proyek </h1>
            <div className="d-flex align-items-center">
              <div style={{ fontWeight: 400, fontSize: '14px', maxWidth: '500px' }} className="me-1">Ada barbagai macam penawaran proyek untukmu dari berbagai
                macam jenis.</div>
            </div>
          </div>
          {/* End Title */}
              ...
              <tr>
                ...
                <td style={{ maxWidth: '70px' }}>
                  <div className="my-3 d-flex justify-content-center flex-wrap">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" className="btnTable">Ambil</button>
                    <a className="btnTable" href>Tolak</a>
                  </div>
                </td>
              </tr>
              <tr>
          ...
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content" style={{ borderRadius: '50px' }}>
              <div className="modal-body text-center">
                ...
                <p>
                  Kamu sudah mengambil tawaran Proyek, selanjutnya Call Center akan menghubungimu dalam waktu 1x24 jam.
                  Pastikan kamu menerima panggilan untuk menyepakati kontrak kerja.
                </p>
              </div>
...
export default PenawaranProyek;