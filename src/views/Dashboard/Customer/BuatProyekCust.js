          ...
          <form style={{ maxWidth: '1000px', padding: '58px 0 34px' }} className="mx-auto">
            ...
            <div className="row">
              <div className="col d-grid mt-5">
                <Link to="/dashboard/cust/proyek/detail" style={{ backgroundColor: '#FF8A00', borderRadius: '20px', fontSize: '20px', fontWeight: 700, padding: '14px 0' }} className="btn text-white text-center">Submit</Link>
              </div>
            </div>
            {/*end button */}
          </form>
